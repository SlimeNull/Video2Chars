    ...
    namespace Json
    {
        ...
        public class JsonData
        {
            ...
            protected static object Deserialize(JsonData jsonData, Type resultType)
            {
                ...
                else if (resultType == jsonData.GetType())
                {
                    return jsonData;
                }
            ...
            protected static JsonData ParseNumber(ref char[] source, ref int offset)
            {
                ...
                try
                {
                    object template = double.Parse(content.ToString());
                    if ((double)template != (float)(double)template)
                    {
                        return Create((double)template);
                    }
                    else if ((float)(double)template != (int)(double)template)
                    {
                        return Create((float)(double)template);
                    }
                    else
                    {
                        return Create((int)(double)template);
                    }
                }
                catch (Exception ex)
                {
